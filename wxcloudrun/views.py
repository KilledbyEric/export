...
def index(request,_):
    ...
    # else:
        ...
        columns = ['院校代码', '院校名称', '专业代码', '专业名称', '专业简注',  '省份', '城市', '本专', '学制', '学费', '2024选考科目', '2024计划数','2023计划数', '2023投档线', '2023投档位次', '第四轮学科评估结果', '办学特色', '办学性质']
